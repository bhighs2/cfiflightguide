...
2. Use terminology appropriate to the learner.
3. Explain unfamiliar terms.
4. Organize information logically.
5. Use examples, diagrams, or demonstrations when useful.
6. Ask questions that reveal understanding.
7. Listen to the learner's response.
8. Require explanation, application, or teach-back.
...
6. Avoid lengthy explanations during critical phases of flight.
7. Use standardized terminology.
8. Use positive exchange of flight controls.
